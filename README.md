...
3. 서비스 사용량 분석   
상황: 장기 구독 서비스 사용자 수는 많지만, 서비스 내의 전환율이 낮음.   
분석: 사용자 행동 데이터 분석.   
...
처음에 혼동행렬 아이디어 이후에....혼동행렬의 HPO 조절 만 한거 같은데, 다른 분들이 거의 다 해주셔서 편하게 맡은 일부 부분에 집중할수 있었던거 같습니다.   
